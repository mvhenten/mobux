        ...
        if (ch === '\x1b' || ch === '\x07') {
          ...
          switch (this.params[0]) {
            ...
            case 118:
              ...
              break;
            case 133:
              // OSC 133 — FinalTerm / shell-integration semantic prompt.
              // params[1] is "A" / "B" / "C" / "D[;exit]". The host (the
              // mobux TerminalCore wrapper) installs `handleOsc133` to
              // capture markers; libterm itself just dispatches.
              if (typeof this.handleOsc133 === 'function') {
                try { this.handleOsc133(this.params[1]); } catch (_) {}
              }
              break;
          }
