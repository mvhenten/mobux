    var isWindows = globalThis.ace.require("ace/lib/useragent").isWindows;
    module.exports = function initInput(ace) {
        // use showkey --ascii to test
        var HashHandler = globalThis.ace.require("ace/keyboard/hash_handler").HashHandler;
        var KEY_MODS = globalThis.ace.require("ace/lib/keys").KEY_MODS;
        var TERM_MODS = {
            "shift-": 2,
            "alt-": 3,
            "alt-shift-": 4,
